...
<div class="row" id="content">
    ...
    <div class="col-xs-6 col-xs-offset-3" style="margin-top: 100px">
        <div class="well">
            <form class="bs-example form-horizontal" method="post" action="<c:url value="/registration"/> ">
            <fieldset>
                <legend>Registration please:</legend>
            ...
            <input type="submit" class="btn btn-primary center-block" value="Registartion"/>
            </form>
        </div>
    </div>
</div>
